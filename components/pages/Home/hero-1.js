      ...
      <div>
        <div className="h-screen grid content-center">
          <div className="xl:py-32 xl:px-40 px-4  " >
            ...
            font-bold xl:font-normal uppercase leading-none">Imports & </h1>
            <h1 className="heading-main text-8xl text-left font-bold 
            xl:font-normal uppercase leading-none">Distribution</h1>
            ...
            <div className=" ">
              ...
              <p className="xl:w-1/2 mt-2 leading-tight"  >
