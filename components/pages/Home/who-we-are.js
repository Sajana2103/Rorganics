      ...
      <div id="home-who-we-are" >
        <div className="xl:h-screen xl:py-32 xl:px-24 px-4 pt-32">
          ...
          <div id="who-images-container" className="mt-4 flex flex-nowrap xl:gap-20 gap-12 overflow-x-auto md:overflow-x-hidden overflow-y-hidden">
            <div className="w-1/3 lg:h-72 shrink-0 who-image">

              <Image loading="eager" loader={customLoader} 
              className="w-full h-full object-cover" alt="rorganics-brands-we-help" src="/assets/images/slider/1st.jpg" height={400} width={300} />
            </div>
            <div className="w-1/3 lg:h-72 shrink-0 who-image">

              <Image loading="eager" loader={customLoader} 
              className="w-full h-full object-cover" alt="rorganics-brands-we-help" src="/assets/images/slider/2.jpg" height={400} width={300} />
            </div>
            <div className="w-1/3 lg:h-72 shrink-0 who-image">

              <Image loading="eager" loader={customLoader} 
              className="w-full h-full object-cover" alt="rorganics-brands-we-help" src="/assets/images/slider/3.jpg" height={400} width={300} />
            </div>
            <div className="w-1/3 lg:h-72 shrink-0 who-image">

              <Image loading="eager" loader={customLoader} 
              className="w-full h-full object-cover" alt="rorganics-brands-we-help" src="/assets/images/slider/4.jpg" height={400} width={300} />
            </div>
            <div className="w-1/3 lg:h-72 shrink-0 who-image">

              <Image loading="eager" loader={customLoader} 
              className="w-full h-full object-cover" alt="rorganics-brands-we-help" src="/assets/images/slider/5.jpg" height={400} width={300} />
            </div>
